  ...
  <div class="wrap">
    ...
    <div class="foot-bottom">
      ...
      <div class="social-flip" data-cur="GO" aria-label="Social links">
        ...
        <button type="button" class="sf-btn" aria-disabled="true" aria-label="A — coming soon"><span class="sf-inner"><span class="sf-face sf-front">A</span><span class="sf-face sf-back">A</span></span><span class="sf-tip" role="tooltip">Coming soon</span></button>
        ...
        <button type="button" class="sf-btn" aria-disabled="true" aria-label="T — coming soon"><span class="sf-inner"><span class="sf-face sf-front">T</span><span class="sf-face sf-back">T</span></span><span class="sf-tip" role="tooltip">Coming soon</span></button>
      </div>
    </div>
  </div>
</footer>`;

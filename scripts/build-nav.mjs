  ...
  <div class="wrap">
    ...
    <div class="foot-bottom">
      ...
      <div class="social-flip" data-cur="GO" aria-label="Social links">
        ...
        <a class="sf-btn" href="mailto:aryanswaroop.0@gmail.com" target="_blank" rel="noopener noreferrer" aria-label="Email"><span class="sf-inner"><span class="sf-face sf-front">C</span><span class="sf-face sf-back"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="18" height="18" fill="currentColor"><path d="M502.3 190.8c3.9-3.1 9.7-.2 9.7 4.7V400c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V195.6c0-5 5.7-7.8 9.7-4.7 22.4 17.4 52.1 39.5 154.1 113.6 21.1 15.4 56.7 47.8 92.2 47.6 35.7.3 72-32.8 92.3-47.6 102-74.1 131.6-96.3 154.1-113.7zM256 320c23.2.4 56.6-29.2 73.4-41.4 132.7-96.3 142.8-104.7 173.4-128.7 5.8-4.5 9.2-11.5 9.2-18.9 0-20.9-16.9-37.8-37.8-37.8H48C21.5 93.3 0 114.8 0 141.4c0 7.4 3.4 14.3 9.2 18.9 30.6 23.9 40.7 32.4 173.4 128.7 16.8 12.2 50.2 41.8 73.4 41.4z"/></svg></span></span><span class="sf-tip" role="tooltip">Email</span></a>
